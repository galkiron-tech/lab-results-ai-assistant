...
PATIENTS = [
    {
        ...
        "explanations": [
            "🔴 רמת הפריטין שלך נמוכה מאוד. פריטין הוא חלבון שמאחסן ברזל בגוף – רמה נמוכה אומרת שמאגרי הברזל מדולדלים.",
            "זה יכול לגרום לתחושות עייפות, חולשה, קוצר נשימה וקשיי ריכוז, גם אם שאר תוצאות הדם תקינות.",
            "מחסור בברזל שכיח מאוד אצל נשים בגיל הפוריות, בעיקר עקב מחזור חודשי, תזונה דלת ברזל, או צרכים מוגברים.",
            "✅ ערכי ה-WBC, המוגלובין, HbA1c ו-LDL שלך תקינים – אין סימנים לבעיות אחרות בבדיקות אלו.",
        ],
        "questions": [
    ...
    },
    {
        ...
        "explanations": [
            "🔴 ספירת תאי הדם הלבנים שלך גבוהה מהטווח הרגיל. תאי דם לבנים הם תאי מערכת החיסון שנלחמים בזיהומים ודלקות.",
            "עלייה בספירה יכולה להיות תגובה זמנית לזיהום חיידקי או ויראלי, לדלקת, לסטרס פיזי, או לתרופות מסוימות.",
            "ברוב המקרים מדובר בתגובה מוכרת ובמצב שחולף מעצמו – אך חשוב לברר את הסיבה עם הרופא.",
    ...
    },
    {
        ...
        "explanations": [
            ...
            "ערך זה נמצא בטווח של טרום-סוכרת עד סוכרת מסוג 2 בשלבים מוקדמים – ולכן חשוב לדון עם הרופא בצעדים הבאים.",
            "🔴 רמת ה-LDL שלך (138 mg/dL) גבוהה. LDL הוא הכולסטרול ה'רע' שעלול להצטבר בעורקים ולהגביר סיכון לבבי לאורך זמן.",
            "שני ממצאים אלה יחד מצביעים על חשיבות שינויים באורח החיים – תזונה, פעילות גופנית – ואולי טיפול תרופתי.",
            "✅ ה-WBC, המוגלובין והפריטין שלך תקינים.",
        ],
        "questions": [
            "האם רמת ה-HbA1c שלי מצביעה על סוכרת או על טרום-סוכרת?",
            "אילו שינויים תזונתיים יכולים לסייע בהורדת הסוכר והכולסטרול?",
            "האם אני זקוק לתרופות להורדת כולסטרול (סטטינים) כבר עכשיו?",
            "מה הסיכון הלבבי שלי, ואיך ניתן להפחיתו?",
    ...
    },
    {
        ...
        "explanations": [
            "🔴 רמת ההמוגלובין שלך נמוכה מהטווח התקין לנשים. המוגלובין הוא החלבון בתאי הדם האדומים שנושא חמצן לכל תאי הגוף.",
            "רמה נמוכה (אנמיה) יכולה לגרום לעייפות, חולשה, סחרחורת, דפיקות לב ועור חיוור – תלוי בחומרה.",
            "הפריטין שלך נמצא בתחתית הטווח התקין – ייתכן שמחסור ברזל תורם לאנמיה. הרופא עשוי לבדוק זאת לעומק.",
            "✅ ה-WBC, HbA1c ו-LDL שלך תקינים לחלוטין.",
        ],
        "questions": [
            "מה הסיבה לאנמיה שלי – מחסור בברזל, בוויטמין B12, או סיבה אחרת?",
            "האם נדרשות בדיקות נוספות כמו ספירת דם מלאה עם מדדי אנמיה?",
            "האם יש צורך בטיפול כבר עכשיו, ואם כן – מה הטיפול המתאים לי?",
            "אילו מזונות מומלץ לי לצרוך כדי לסייע לרמות ההמוגלובין?",
            "מה עלי לצפות מבחינת שיפור בתסמינים לאחר תחילת הטיפול?",
        ],
    },
]
